...
public class »¶Ó­½çÃæ extends JFrame {
	...
	public »¶Ó­½çÃæ() {
		...
		textField.setFont(new Font("ËÎÌå", Font.PLAIN, 22));
		...
		btnNewButton.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 26));
